...
Acest proiect folosește [GitHub Issues](https://github.com/peviitor-scrapers/direct-one-sa-python-scraper/issues) pentru a urmări munca.
...
Vezi [toate issue-urile](https://github.com/peviitor-scrapers/direct-one-sa-python-scraper/issues).
...
`22913844` and the failing endpoint.
