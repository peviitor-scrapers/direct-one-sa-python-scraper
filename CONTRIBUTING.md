...
```bash
git clone git@github.com:peviitor-scrapers/direct-one-sa-python-scraper.git
cd direct-one-sa-python-scraper
...
[peviitor-scrapers/direct-one-sa-python-scraper/issues](https://github.com/peviitor-scrapers/direct-one-sa-python-scraper/issues).
