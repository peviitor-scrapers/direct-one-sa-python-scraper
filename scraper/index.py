"""
DIRECT ONE SA applytojob Scraper — derived from the ELECTROGRUP Python template.

Scrapes DIRECT ONE job listings from the group applytojob board (electrogrup.applytojob.com) filtered by
...
def main(root=None):
    ...
    print(f"Jobs scraped from the DIRECT ONE applytojob board: {scraped_count}")
