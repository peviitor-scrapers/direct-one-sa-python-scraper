...
### Added
- Python scraper for the DIRECT ONE SA department on the group's applytojob board (`?department=Direct One`).
...
- E2E `EXPECTED_MIN_JOBS` and integration tests reflect the DIRECT ONE department and CIF `22913844`.
